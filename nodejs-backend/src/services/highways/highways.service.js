const { Highways } = require("./highways.class");
const createModel = require("./highways.model");
const hooks = require("./highways.hooks");
...
module.exports = function (app) {
  ...
  app.use("/highways", new Highways(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("highways");

  // Get the schema of the collections 
  app.get("/highwaysSchema", function (request, response) {
