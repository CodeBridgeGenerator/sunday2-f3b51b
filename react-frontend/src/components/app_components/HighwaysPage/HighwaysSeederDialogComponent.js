...
import seederData from "./highways.seeder.json";
...
const HighwaysSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(HighwaysSeederDialogComponent);
